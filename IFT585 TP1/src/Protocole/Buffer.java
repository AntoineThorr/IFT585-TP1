...
TODO : Il serait plus "orienté object" d'en faire une classe abstraite et de 
        ...
        hériteraient de celle-ci. Ce n'est probablement pas une préoccupation
        par contre pour un travail de télématique.
*/
...
public class Buffer {
    ...
    // Fonction permettant de rajouter une trame dans le buffer sans égards à
    //   sa position.
    // Retourne TRUE si la trame a pu être placée. FALSE, sinon.
    ...
    // Fonction permettant de rajouter une trame dans le buffer à la position
    //   indiquée par son numéro de trame.
    // Retourne TRUE si la trame a pu être placée et que la position existe dans
    //   le buffer. FALSE, sinon.
    //
    // Permet d'inscrire en ordre les trames lors de la réception ce qui aide
    //   le traitement quand on ne les reçoit pas dans l'ordre.
