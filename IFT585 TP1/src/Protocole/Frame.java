 ...
 *
 * TODO : Il manque les algorithmes permettant de rajouter le code détecteur et
 * le code correcteur (Hamming).
 */
public class Frame {
     ...
     * c'est un ACK (TRUE) ou un NACK (FALSE). La convention maison est qu'un 0
     * au début des données indique un NACK et un 1 (n'importe quoi d'autre dans
     * les faits) est un ACK. TODO : La fonction devrait avoir un peu plus de
     * protection.
     */
